...
#ifndef SOAP_TYPE_ns__GetCity
#define SOAP_TYPE_ns__GetCity (11)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__GetCity(struct soap*, struct ns__GetCity *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__GetCity(struct soap*, const struct ns__GetCity *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__GetCity(struct soap*, const char*, int, const struct ns__GetCity *, const char*);
SOAP_FMAC3 struct ns__GetCity * SOAP_FMAC4 soap_in_ns__GetCity(struct soap*, const char*, struct ns__GetCity *, const char*);

#ifndef soap_write_ns__GetCity
#define soap_write_ns__GetCity(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__GetCity(soap, data), 0) || soap_put_ns__GetCity(soap, data, "ns:GetCity", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__GetCity(struct soap*, const struct ns__GetCity *, const char*, const char*);

#ifndef soap_read_ns__GetCity
#define soap_read_ns__GetCity(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__GetCity(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__GetCity * SOAP_FMAC4 soap_get_ns__GetCity(struct soap*, struct ns__GetCity *, const char*, const char*);

#define soap_new_ns__GetCity(soap, n) soap_instantiate_ns__GetCity(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__GetCity(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__GetCity * SOAP_FMAC2 soap_instantiate_ns__GetCity(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__GetCity(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__GetCityResponse
#define SOAP_TYPE_ns__GetCityResponse (10)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__GetCityResponse(struct soap*, struct ns__GetCityResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__GetCityResponse(struct soap*, const struct ns__GetCityResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__GetCityResponse(struct soap*, const char*, int, const struct ns__GetCityResponse *, const char*);
SOAP_FMAC3 struct ns__GetCityResponse * SOAP_FMAC4 soap_in_ns__GetCityResponse(struct soap*, const char*, struct ns__GetCityResponse *, const char*);

#ifndef soap_write_ns__GetCityResponse
#define soap_write_ns__GetCityResponse(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__GetCityResponse(soap, data), 0) || soap_put_ns__GetCityResponse(soap, data, "ns:GetCityResponse", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__GetCityResponse(struct soap*, const struct ns__GetCityResponse *, const char*, const char*);

#ifndef soap_read_ns__GetCityResponse
#define soap_read_ns__GetCityResponse(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__GetCityResponse(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__GetCityResponse * SOAP_FMAC4 soap_get_ns__GetCityResponse(struct soap*, struct ns__GetCityResponse *, const char*, const char*);

#define soap_new_ns__GetCityResponse(soap, n) soap_instantiate_ns__GetCityResponse(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__GetCityResponse(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__GetCityResponse * SOAP_FMAC2 soap_instantiate_ns__GetCityResponse(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__GetCityResponse(struct soap*, int, int, void*, size_t, const void*, size_t);
