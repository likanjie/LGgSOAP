...
#  define SOAP_BUFLEN (8) /* buffer length for socket packets, also used by gethostbyname_r and UDP messages, so don't make this too small */
# else
/*#  define SOAP_BUFLEN  (2048) // lean size */
#  define SOAP_BUFLEN  (8) /* lean size */
# endif
#endif
#ifndef SOAP_LABLEN
